(function (gTh, midifilefunc) { "object" == typeof exports && "undefined" != typeof module ? module.exports = midifilefunc() : "function" == typeof define && define.amd ? define(midifilefunc) : (gTh = "undefined" != typeof globalThis ? globalThis : gTh || self).MIDIFile = midifilefunc() })(this, function () {/* from https://github.com/fraigo/javascript-midi-player/tree/master/midiplayer */
    var UTF8 = {
    ...
    MIDIFile.prototype.loadSongWithCbfunc = function (buffer, strictMode, cbfunc) {
        var track;
        var curIndex;
        var i;
        var j;
        ...
        if (typeof cbfunc === 'function') { return cbfunc(this) } else { return null }
    }
